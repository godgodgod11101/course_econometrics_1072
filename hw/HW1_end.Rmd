...
stargazer(model1, model2,
          ...
          se = list(model1_coeftest[,"Std. Error"], model1_coeftest[,"Std. Error"]),
          type = "html",
          align = T
          )
...
<ul>
  <li>若考慮控制變數$經原PR$，$可修個體$的估計係數從0.079降到0.068，代表簡迴歸下$可修個體$的估計係數有正向偏誤，真實的效應值應該較小</li>
</ul>
